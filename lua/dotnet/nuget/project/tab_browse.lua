...
-- @param prerelease Whether to include prerelease packages.
...
--- @param state table Per-instance state holding the showing_versions flag.
...
-- @param opts Options table: prerelease (boolean) includes prerelease packages in search.
function M.new(proj_file, opts)
    opts = opts or {}
